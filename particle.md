...
Nodebots Day will use the [Particle Core](https://www.particle.io) (formerly known as the Spark). This is a microcontroller, similar to the Arduino in functionality, but with an integrated wifi chip. Perfect for Bots, like Boats, that need to be physically untethered from your computer!

### Setting Up Your Particle

Before you set up your Particle, make sure you have version of [Node JS](https://nodejs.org) installed on your computer! If you use a different version or [io.js](https://iojs.org/en/index.html), you'll run into compatibility issues and it'll be a bad time. To check your version:
```bash
node -v
```
...
The Particle has a nifty mobile app that can help you claim it, but you should NOT use that! In a conference setting like this, it can have unpredictable results. Instead you should use particle-cli, Particle's command line tool.
...
Now you can move on to the [Johnny-Five](http://johnny-five.io) docs and have fun building your boat!